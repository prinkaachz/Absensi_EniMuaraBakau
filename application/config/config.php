...
|
*/
$config['base_url'] = 'http://localhost/Absensi_EniMuaraBakau/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = 'eni-muara-bakau-ganti-dengan-kunci-acak-produksi';
...
$config['sess_save_path'] = '/tmp/eni_muarabakau_sessions';
